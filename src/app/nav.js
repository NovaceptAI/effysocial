...
export const NAV = [
  ...
  { group: 'Strategy', items: [
    ...
    { label: 'Workflows', to: '/app/workflows', icon: Workflow, phase: 1 },
  ...
  { group: 'Publish', items: [
    ...
    { label: 'Approvals', to: '/app/approvals', icon: CheckSquare, phase: 1 },
    { label: 'Published', to: '/app/published', icon: Send, phase: 1 },
  ]},
  { group: 'Engage', items: [
    { label: 'Unified Inbox', to: '/app/inbox', icon: Inbox, phase: 1 },
  ...
  { group: 'Convert', items: [
    ...
    { label: 'Lead Pipeline', to: '/app/pipeline', icon: GitBranch, phase: 1 },
    { label: 'Follow-ups', to: '/app/followups', icon: Repeat2, phase: 1 },
    { label: 'Conversion Tracking', to: '/app/tracking', icon: Crosshair, phase: 1 },
  ]},
  { group: 'Analytics', items: [
    { label: 'Organic', to: '/app/analytics/organic', icon: BarChart3, phase: 1 },
    { label: 'Advertising', to: '/app/analytics/ads', icon: LineChart, phase: 1 },
