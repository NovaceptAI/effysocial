...
import { Check, Loader2, Pencil, Plus, X, ShieldCheck, Sparkles, Info, Upload, Image as ImageIcon, MessageSquareText } from 'lucide-react';
  ...
  return (
    <div>
      ...
      <div className="grid lg:grid-cols-2 gap-4 items-start mt-4">
        ...
        <BrandSources workspaceId={workspace.id} sources={brain.sources?.data || []} onChanged={refetch} />
      </div>
